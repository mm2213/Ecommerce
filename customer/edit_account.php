...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" name="c_name" class="form-control" value="<?php echo $customer_id; ?>" required>
    ...
    <img class="img-responsive" width="20%" height="20%" src="customer_images/<?php echo $customer_image; ?>" alt="Customer Image">
